...
INSERT INTO `tblcategoriamateria` VALUES (6,'fdfdsfsdf'),(7,'erefsfesfsf'),(8,'dsssssssssss');
...
CREATE TABLE `tblcategoriaprato` (
  ...
  `nomeCategoriaProduto` varchar(60) DEFAULT NULL,
...
CREATE TABLE `tblestoque` (
  ...
  `quantidadeLimte` int(11) DEFAULT NULL,
...
--
-- Table structure for table `tblmateriaestoque`
--

DROP TABLE IF EXISTS `tblmateriaestoque`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tblmateriaestoque` (
  `codMateriaEstoque` int(11) NOT NULL AUTO_INCREMENT,
  `codMateria` int(11) DEFAULT NULL,
  `codEstoque` int(11) DEFAULT NULL,
  PRIMARY KEY (`codMateriaEstoque`),
  KEY `codMateria` (`codMateria`),
  KEY `codEstoque` (`codEstoque`),
  CONSTRAINT `tblmateriaestoque_ibfk_1` FOREIGN KEY (`codMateria`) REFERENCES `tblmateriaprima` (`codMateria`),
  CONSTRAINT `tblmateriaestoque_ibfk_2` FOREIGN KEY (`codEstoque`) REFERENCES `tblestoque` (`codEstoque`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblmateriaestoque`
--

LOCK TABLES `tblmateriaestoque` WRITE;
/*!40000 ALTER TABLE `tblmateriaestoque` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblmateriaestoque` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tblmateriaprima` (
  ...
  `precoMateria` decimal(10,0) DEFAULT NULL,
  `descricaoMateria` text,
  `porcaoMateria` float DEFAULT NULL,
...
CREATE TABLE `tblparceiro` (
  ...
  KEY `codEmpresa` (`codEmpresa`),
  CONSTRAINT `tblparceiro_ibfk_1` FOREIGN KEY (`codEmpresa`) REFERENCES `tblempresa` (`codEmpresa`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `tblparceiroend`
--

DROP TABLE IF EXISTS `tblparceiroend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tblparceiroend` (
  `codParceiroEnd` int(11) NOT NULL AUTO_INCREMENT,
  `codEndereco` int(11) DEFAULT NULL,
  `codParceiro` int(11) DEFAULT NULL,
  PRIMARY KEY (`codParceiroEnd`),
  KEY `codEndereco` (`codEndereco`),
  KEY `codParceiro` (`codParceiro`),
  CONSTRAINT `tblparceiroend_ibfk_1` FOREIGN KEY (`codEndereco`) REFERENCES `tblendereco` (`codEndereco`),
  CONSTRAINT `tblparceiroend_ibfk_2` FOREIGN KEY (`codParceiro`) REFERENCES `tblparceiro` (`codParceiro`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblparceiroend`
--

LOCK TABLES `tblparceiroend` WRITE;
/*!40000 ALTER TABLE `tblparceiroend` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblparceiroend` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tblprato` (
  ...
  `precoPrato` decimal(10,0) DEFAULT NULL,
  `descricaoPrato` text,
  `caloria` decimal(10,0) DEFAULT NULL,
  `valorEnergetico` decimal(10,0) DEFAULT NULL,
  `carboidrato` decimal(10,0) DEFAULT NULL,
  `proteina` decimal(10,0) DEFAULT NULL,
  `sodio` decimal(10,0) DEFAULT NULL,
  `gorduras` decimal(10,0) DEFAULT NULL,
...
CREATE TABLE `tblproduto` (
  ...
  `caloriaProduto` decimal(10,0) DEFAULT NULL,
  `valorEnergeticoProduto` decimal(10,0) DEFAULT NULL,
  `carboidratoProduto` decimal(10,0) DEFAULT NULL,
  `proteinaProduto` decimal(10,0) DEFAULT NULL,
  `sodioProduto` decimal(10,0) DEFAULT NULL,
  `gordurasProduto` decimal(10,0) DEFAULT NULL,
  `dtFabricacaoProduto` date DEFAULT NULL,
...
--
-- Table structure for table `tblprodutoestoque`
--

DROP TABLE IF EXISTS `tblprodutoestoque`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tblprodutoestoque` (
  `codProdutoEstoque` int(11) NOT NULL AUTO_INCREMENT,
  `codProduto` int(11) DEFAULT NULL,
  `codEstoque` int(11) DEFAULT NULL,
  PRIMARY KEY (`codProdutoEstoque`),
  KEY `codProduto` (`codProduto`),
  KEY `codEstoque` (`codEstoque`),
  CONSTRAINT `tblprodutoestoque_ibfk_1` FOREIGN KEY (`codProduto`) REFERENCES `tblproduto` (`codProduto`),
  CONSTRAINT `tblprodutoestoque_ibfk_2` FOREIGN KEY (`codEstoque`) REFERENCES `tblestoque` (`codEstoque`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tblprodutoestoque`
--

LOCK TABLES `tblprodutoestoque` WRITE;
/*!40000 ALTER TABLE `tblprodutoestoque` DISABLE KEYS */;
/*!40000 ALTER TABLE `tblprodutoestoque` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tbltranspend`
--

DROP TABLE IF EXISTS `tbltranspend`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbltranspend` (
  `codTranspEnd` int(11) NOT NULL AUTO_INCREMENT,
  `codEndereco` int(11) DEFAULT NULL,
  `codTransportadora` int(11) DEFAULT NULL,
  PRIMARY KEY (`codTranspEnd`),
  KEY `codEndereco` (`codEndereco`),
  KEY `codTransportadora` (`codTransportadora`),
  CONSTRAINT `tbltranspend_ibfk_1` FOREIGN KEY (`codEndereco`) REFERENCES `tblendereco` (`codEndereco`),
  CONSTRAINT `tbltranspend_ibfk_2` FOREIGN KEY (`codTransportadora`) REFERENCES `tbltransportadora` (`codTransportadora`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbltranspend`
--

LOCK TABLES `tbltranspend` WRITE;
/*!40000 ALTER TABLE `tbltranspend` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbltranspend` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbltransportadora` (
  ...
  `nomeTransportadora` varchar(60) DEFAULT NULL,
  `cnpjTransportadora` varchar(14) DEFAULT NULL,
  `emailTransportadora` varchar(100) DEFAULT NULL,
  `telefoneTransportadora` varchar(20) DEFAULT NULL,
...
-- Dump completed on 2016-10-14 16:12:27
