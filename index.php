...
<?php 
	...
	$lstCtrlCMS = array('cms', 'categoria','funcionario', 'objetivo','tipoUsuario','parceiro','prato','categoriaPrato','ingrediente','produtocms','promocao','marketing','estoque','sobre','clientes','exercicios','dicas');
